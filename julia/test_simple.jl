...
# include("src/SwarmManager/CoordinationFunctions.jl")

# Include SwarmManager directly
...
# Test 3: Test broadcasting a message
println("\n--- Test 3: Test broadcasting a message ---")
...
# Test 4: Test OpenAI Swarm (if API key is available)
println("\n--- Test 4: Test OpenAI Swarm ---")
